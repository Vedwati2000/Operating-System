...
function RecipeHome() {
  ...
  const fetchRecipes = () => {
    fetch("https://backend-system-um4y.onrender.com/api/recipes")
      .then((res) => res.json())
  ...
  function handleAddRecipe() {
    if (recipeName && recipePrice && recipeImage) {
      ...
      if (editId) {
        fetch(`https://backend-system-um4y.onrender.com/api/recipes/${editId}`, {
          method: "PUT",
  ...
  function handleDelete(id) {
    fetch(`https://backend-system-um4y.onrender.com/api/recipes/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then(() => {
